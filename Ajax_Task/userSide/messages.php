...
<head>
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/msgUsers.php',
        ...
        $(document).ready(function() {
            $('#sendMSG').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/sendMSG.php',
                    data: {
                        reciverID: reciverID,
                        content: content,
                    },
        ...
        function showMsgThisUser(ids) {
            ...
            $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/msgBetweenUsers.php',
                data: {
                    reciverID: id
                },
                success: function(response) {
