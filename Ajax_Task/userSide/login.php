...
<head>
  ...
  <body>
    ...
    $('#loginForm').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/Login.php',
            data: {
                email: email,
                password: password,
            },
            success: function(response) {
                ...
                if (response.startsWith('Error :')) {
                    ...
                    if (response.startsWith('Alert :')){
                        ...
                        window.location = "http://localhost/Ajax_2/Ajax_Task/userSide/login.php";
                    }
                    else {
                        console.log(response);
                        if (response.startsWith('1')){
                            console.log("Admin");
                            window.location = "http://localhost/Ajax_2/Ajax_Task/Admin/dashboard.php";
                        } 
                        else {
                            console.log("User");
                            window.location = "http://localhost/Ajax_2/Ajax_Task/userSide/home.php";
                        }
                    }
