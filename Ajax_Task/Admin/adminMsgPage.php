    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    data += '<a class="" href="./dashboard.php"><button class="btn btn-info">Back To Dashboard</button></a>'
                    data += '</ul>';
        ...
        $(document).ready(function() {
            $('#sendMSG').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://localhost/Ajax_2/Ajax_Task/Admin/sendMsgAdmin.php',
                    data: {
                        reciverID: reciverID,
                        content: content,
                    },
        ...
        function showMsgThisUser(ids) {
            ...
            $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/Admin/msgBetweenAdmin.php',
                data: {
                    reciverID: id
                },
                success: function(response) {
