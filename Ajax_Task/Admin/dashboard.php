    ...
    <div class="modal-dialog">
      ...
      <div class="container my-5">
        ...
        <script>
          ...
          function setUserDataInTable() {
            $(document).ready(function() {
              $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/users.php',
          ...
          function makeActive(id) {
            $(document).ready(function() {
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/makeActive.php',
                data: {
                  id: id
                },
                success: function(response) {
         ...
         // Make unActive Func
          ...
          function makeUnActive(id) {
            $(document).ready(function() {
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/makeUnActive.php',
                data: {
                  id: id
                },
                success: function(response) {
          ...
          $(document).ready(function() {
            $('#delete-form').submit(function(e) {
              ...
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/deleteUser.php',
                data: {
                  id: id,
                },
                success: function(response) {
          ...
          function myFunc(id) {
            $(document).ready(function() {
              $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/userPop.php',
                data: {
                  id: id
                },
                success: function(response) {
          ...
          $(document).ready(function() {
            $('#update-form').submit(function(e) {
              ...
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/userUpdate.php',
                data: {
                  username: name,
                  email: email,
                  id: id,
          ...
          $(document).ready(function() {
            ...
            $('#addNewCourse-form').submit(function(e) {
              ...
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/addCourse.php',
                data: {
          ...
          function getAllCourses() {
            $(document).ready(function() {
              $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/getAllCourses.php',
                success: function(response) {
          ...
          document.getElementById("CrsNameAssign").onchange = function load() {
            ...
            $(document).ready(function() {
              ...
              $.ajax({
                type: 'GET',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/getNotAssignedStu.php',
                data: {
                  id: id
                },
                success: function(response) {
          ...
          $(document).ready(function() {
            $('#assignCourse-form').submit(function(e) {
              ...
              $.ajax({
                type: 'POST',
                url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/addStudentToCourse.php',
                data: {
                  nameOfCourse: nameOfCourse,
                  stuName: stuName,
                },
        ...
        document.getElementById("CrsNameMark").onchange = function load(){
            ...
            $.ajax({
            type: 'GET',
            url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/getAssignedStu.php',
            data : {id : id},
            success: function(response) {
        ...
        $(document).ready(function() {
            ...
            $.ajax({
            type: 'POST',
            url: 'http://localhost/Ajax_2/Ajax_Task/BackEnd/assignMark.php',
            data: {
                nameOfCourse : nameOfCourse,
